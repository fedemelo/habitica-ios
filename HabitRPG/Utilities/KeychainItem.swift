...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.habitrpg.ios.fede.habitica", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.habitrpg.ios.fede.habitica", account: "userIdentifier").deleteItem()
        } catch {
