...
class GiftGemsViewController: BaseUIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        var amount = 0
        if product.productIdentifier == "com.habitrpg.ios.fede.Habitica.4gems" {
            amount = 4
        } else if product.productIdentifier == "com.habitrpg.ios.fede.Habitica.21gems" {
            amount = 21
        } else if product.productIdentifier == "com.habitrpg.ios.fede.Habitica.42gems" {
            amount = 42
        } else if product.productIdentifier == "com.habitrpg.ios.fede.Habitica.84gems" {
            amount = 84
        }
